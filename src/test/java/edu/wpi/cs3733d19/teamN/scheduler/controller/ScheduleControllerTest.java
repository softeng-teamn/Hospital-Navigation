...
import edu.wpi.cs3733d19.teamN.scheduler.controller.ScheduleController;
...
//        when(dbs.insertReservation(reservC)).thenReturn(false) ;
        ...
        when(dbs.getEmployee(123)).thenReturn(new Employee(123, "username", "first", "last", JobType.JANITOR, false, "password"));
...
/*
    ...
    public void createReservation() {
        ...
        assertTrue(ScheduleController.myDBS.getReservation(0).getEventID() == r.getEventID());
        assertTrue(ScheduleController.myDBS.getReservation(0).getPrivacyLevel() == r.getPrivacyLevel());
        assertTrue(ScheduleController.myDBS.getReservation(0).getEmployeeId() == r.getEmployeeId());
        assertTrue(ScheduleController.myDBS.getReservation(0).getEventName().equals(r.getEventName()));
        assertTrue(ScheduleController.myDBS.getReservation(0).getLocationID() == r.getLocationID());
        assertTrue(ScheduleController.myDBS.getReservation(0).getStartTime().equals(r.getStartTime()));

...
public class CSVServiceTest {
    ...
    public void importEdges() throws Exception {
        ...
        // Override the csv file
        setFinalStatic(ResourceLoader.class.getDeclaredField("edges"), ResourceLoader.class.getResource("/test_edges.csv"));
    ...
    public void importReservableSpaces() throws Exception {
        ...
        URL originalURL = ResourceLoader.nodes;
        // Override the csv file
        setFinalStatic(ResourceLoader.class.getDeclaredField("reservablespaces"), ResourceLoader.class.getResource("/test_reservablespaces.csv"));
    ...
    public void importEmployees() throws Exception {
        ...
        // Override the csv file
        setFinalStatic(ResourceLoader.class.getDeclaredField("employees"), ResourceLoader.class.getResource("/test_employees.csv"));

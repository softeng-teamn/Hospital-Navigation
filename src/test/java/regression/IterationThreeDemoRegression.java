...
public class IterationThreeDemoRegression extends ApplicationTest {
    ...
    public void iterationThreeDemoRegression() {
        ...
        testPathfind("BTM Conference Center", "Flexible Amphitheater", 9);
        ...
        testPathfind("Cafe", "Obstetrics", 9);
        ...
        testPathfind("Cafe", "Obstetrics", 10);
        ...
        // 11. Go to fulfill requests, verify 1 help me request
    }
    ...
    private void testPathfind(String from, String to, int expectedChildrenInGroup) {
        ...
        clickOn("#startSearch").write(from).type(KeyCode.ENTER);
        ...
        clickOn("#search_bar").write(to).type(KeyCode.ENTER);
        listView = GuiTest.find("#list_view");
